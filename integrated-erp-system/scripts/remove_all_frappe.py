...
Processes ALL files and removes ALL Frappe references
"""
...
def process_file(file_path):
    """Process a single file to remove Frappe dependencies"""
    try:
...
"""
        ...
        # Replace any remaining frappe. references
...
def main():
    ...
    print("Starting Frappe dependency removal...")
    ...
    print(f"\nCompleted: {files_processed} files processed")
